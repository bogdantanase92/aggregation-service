...
public class CacheServiceImpl implements CacheService {
    ...
    private HashMap<String, Set<String>> createParams(Set<String> shipmentOrderNumbers,
        ...
        if (!CollectionUtils.isEmpty(shipmentOrderNumbers)) {
            params.put(AggregationServiceImpl.SHIPMENTS, shipmentOrderNumbers);
        }
        if (!CollectionUtils.isEmpty(trackOrderNumbers)) {
            params.put(AggregationServiceImpl.TRACK, trackOrderNumbers);
        }
        if (!CollectionUtils.isEmpty(pricingCountryCodes)) {
            params.put(AggregationServiceImpl.PRICING, pricingCountryCodes);
        }
    ...
    private Map<String, Set<String>> updateCache(Map<String, Set<String>> params) {
        ...
        values.put(AggregationServiceImpl.SHIPMENTS, null);
        values.put(AggregationServiceImpl.TRACK, null);
        values.put(AggregationServiceImpl.PRICING, null);
    ...
    private Set<String> getAPINames() {
        return Set.of(AggregationServiceImpl.SHIPMENTS, AggregationServiceImpl.TRACK, AggregationServiceImpl.PRICING);
    }
